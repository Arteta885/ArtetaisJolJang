...
results_kim <- data.frame(
  Topic = factor(rep(1:4, each=1), levels=1:4),
  Variable = rep("contains_kimyes", times=4),
  Estimate = c(0.001533, -0.0144292, 0.0223009, -0.009408),
  Std.Error = c(0.008032, 0.0082985, 0.0074930, 0.009949),
  p.value = c(0.849, 0.0821, 0.00292, 0.344)
)
...
ggplot(results_kim, aes(x=Topic, y=Estimate, fill=Significance)) +
  ...
  labs(title="Effect of 'kim' on Each Topic(Moratorium)",
       x="Topic",
       y="Estimate") +
